...
public class RedisUtils {
    ...
    public Long getExpire(String key, TimeUnit unit) {
        if (null == key || null == unit) {
            throw new BusinessException1( "key or TomeUnit 不能为空");
        }
    ...
    public Boolean setIfAbsent(String key, Object value, long time, TimeUnit unit) {
        ...
        if (null == key || null == value || null == unit) {
            throw new BusinessException1("key、value、unit都不能为空");
        }
    ...
    public long incrBy(String key, long increment) {
        if (null == key) {
            throw new BusinessException1( "key不能为空");
        }
     ...
     * 在decr by之后其值为-decrement。如果Value的值不能转换为整型值，
    ...
    public Long hashIncrBy(String key, Object field, long increment) {
        if (null == key || null == field) {
            throw new BusinessException1( "key or field 不能为空");
        }
     ...
     */
    public Long listLeftPush(String key, Object... sTrs) {
        if (null == key) {
            return 0L;
        }
     ...
     * @return java.lang.Long 返回操作的value个数
     */
    public Long listRightPush(String key, Object... str) {
        if (null == key) {
            return 0L;
        }
     ...
     * 注：Redis的列表起始索引为0。显然，L RANGE numbers 0 -1 可以获取列表中的所有元素。返回指定范围内元素的列表。
     *
     * @param key
     * @param start
     * @param end
    ...
    /**
     * 和S POP一样，随机的返回Set中的一个成员，不同的是该命令并不会删除返回的成员。
     *
     * @param key
     ...
     * 当count 为正数时，set Random Members会随机从集合里获得count个不重复的元素。
     * 如果count的值大于集合中的元素个数，则 set Random Members 会返回集合中的全部元素。
     * 当count为负数时，set Random Members 会随机从集合里获得|count|个的元素，如果|count|大与集合中的元素，
     ...
     * @return java.lang.Long
     */
    public Boolean zSetAdd(String key, double score, Object member) {
        if (null == key) {
            return false;
        }
     ...
     */
    public Double zSetIncrBy(String key, double score, Object member) {
        if (null == key) {
            throw new BusinessException1("key 不能为空");
        }
     ...
     * zSetCount key min (max 则表明(min=<score<max) 返回指定返回数量。
     *
     * @param key
     * @param min
     * @param max
     ...
     * 该命令将返回从start到集合的最后一个成员。如果命令中带有可选参数WITH SCORES选项，
     ...
     */
    public Set<Object> zSetRange(String key, long min, long max) {
        if (null == key) {
            return null;
        }
    ...
    /**
     * 该命令的功能和Z RANGE基本相同，唯一的差别在于该命令是通过反向排序获取指定位置的成员，
     ...
     * 可选参数WITH SCORES的含义参照Z RANGE中该选项的说明。*最后需要说明的是参数中min和max的规则可参照命令Z COUNT。
     *
     * @param key
     * @param max
     * @param min
    ...
    /**
     * 该命令除了排序方式是基于从高到低的分数排序之外，其它功能和参数含义均与Z RANGE BY SCORE相同。
     * 需要注意的是该命令中的min和max参数的顺序和Z RANGE BY SCORE命令是相反的。
     *
     * @param key
     * @param max
     * @param min
     * @return java.util.Set<java.lang.String>
     */
    public Set<Object> zSetRevRangeByScore(String key, double min, double max) {
        if (null == key) {
            return null;
        }
