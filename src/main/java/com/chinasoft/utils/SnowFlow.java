...
public class SnowFlow {
    ...
    /**
     *
     * @param workerId 机器ID  2进制5位  32位减掉1位 31个
     * @param datacenterId 机房ID 2进制5位  32位减掉1位 31个
     * @param sequence 代表一毫秒内生成的多个id的最新序号  12位 4096 -1 = 4095 个
     */
    ...
    public static void main(String[] args) {
        SnowFlow snowFlow = new SnowFlow(1, 1, 1000);
        for (int i = 0; i < 22; i++) {
